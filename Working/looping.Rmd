...
possible_cars$power = apg(v=speed_base, sa = possible_cars$area, m=possible_cars$mass)
...
powerA = apg(V=speeds, A = possible_cars$area[1], m=possible_cars$mass[1])
# lets look at what we get
summary(powerA)

# next car (row 2)
powerB = apg(V=speeds, A = possible_cars$area[2], m=possible_cars$mass[2])
# lets look at what we get
summary(powerB)

# next car (row 3)
powerC = apg(V=speeds, A = possible_cars$area[3], m=possible_cars$mass[3])
# lets look at what we get
summary(powerC)
